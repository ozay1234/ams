...
<div class="panel panel-info">
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Password</td><td><b><input type="text" name="password" value="<?php echo $password; ?>" style="width: 300px" class="form-control" tabindex="1" autofocus></b></td></tr>
