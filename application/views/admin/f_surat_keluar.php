...
?>
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Tujuan Surat</td><td><b><input type="text" tabindex="2" name="tujuan" required value="<?php echo $tujuan; ?>" id="tujuan" style="width: 400px" class="form-control"></b></td></tr>		
