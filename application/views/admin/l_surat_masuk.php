...
<table class="table table-bordered table-hover">
	<thead>
		<tr>
			...
			<th width="25%">Asal Surat, Tujuan Surat</th>
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $b->perihal."<br><b>File : </b><i><a href='".base_URL()."upload/surat_masuk/".$b->file."' target='_blank'>".$b->file."</a>"?></td>
			<td><?php echo $b->asal."<br>".$b->tujuan; ?></td>
